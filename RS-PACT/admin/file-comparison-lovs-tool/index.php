...
<section class="offering" id="offering">
    <div class="container" >
        <div class="section-title">
            <h2>File Comparison Tool(LOVS)</h2>
        </div>
        <br>
                    ...
                    <div class="row justify-content-center">
                       <div class="card-body col-lg-10 col-md-11">
                           <div class="file-field">
                              <label class="form-control-label">Old version file (Excel Format) </label><span class="label label-danger">new</span>
                              <input type="file" id="rsexcel" name="rsexcel" class="" onchange=" firstInputfile()" multiple accept=".xls , .xlsm , .xlsx"  onblur="validate1(1)">
                            </div>
                            <div class="file-field">
                                <label class="form-control-label">New version file (Excel Format) </label>
                                <input type="file" id="externalexcel" name="externalexcel" class=""  onchange="secondInputfile()" multiple accept=".xls , .xlsm , .xlsx" 
                                    onblur="validate1(2)">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card b-0">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-11">
                           <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-11">
                            <button class="btn" id="download"><i class="fa fa-download"></i> Updated file
                                with Data</button>
                        </div>
                        </div>
                    </div>
...
<script type="text/javascript" language="javascript" >
   ...
   var JSON_PATH = HTTP_SERVER+ "admin/file-comparison-lovs-tool/";
</script>
    ...
    <script src="<?php echo HTTP_SERVER?>admin/file-comparison-lovs-tool/assets/js/script.js"> </script>
